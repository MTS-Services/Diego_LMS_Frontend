...
const navLinksData = [
  { name: 'Home', icon: <TfiHome />, path: '/level-three/home' },
  {
    name: 'Gestisci la formazione',
    icon: <FaUsers />,
    path: '/level-three/gestisci-la',
  },
  {
    name: 'I tuoi attestati',
    icon: <PiNoteLight />,
    path: '/level-three/attestati',
  },
];

const FreelancerAdminSidebar = () => {
...
export default FreelancerAdminSidebar;
