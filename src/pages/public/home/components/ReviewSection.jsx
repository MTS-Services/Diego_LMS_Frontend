  ...
  return (
    <div className="items-center overflow-hidden md:flex md:gap-8">
      <Container className="order-2 w-full space-y-8 md:order-1 md:w-1/2">
        ...
        <InputField title="name" type="text" name="name" placeholder="Name *" />
      ...
      <div className="order-1 mt-8 w-full sm:mt-0 md:order-2 md:w-1/2">
        <div className="relative">
          ...
          <div className="absolute -mt-[460px] ml-0 sm:-mt-[600px] md:-mt-[600px] md:ml-20 lg:-mt-[820px] lg:ml-24">
            <img
              className="h-[420px] w-[300px] sm:h-[500px] sm:w-[390px] md:h-[600px] md:w-[208px] lg:h-[720px] lg:w-full"
              src="./image/Componen.jpg"
              alt=""
            />
          </div>
        </div>
