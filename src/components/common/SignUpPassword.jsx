    ...
    <div className="flex h-auto flex-col bg-white md:h-screen">
      <div className="mx-auto w-full max-w-5xl flex-1 px-6 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <p className="text-sm text-gray-600">Steps 3/3</p>
          <button className="rounded-full p-2 hover:bg-gray-100">
            <GrClose className="h-5 w-5 text-gray-500" />
          </button>
        </div>

        <H2 className={''} h2={'Crea la tua password'} />
        <form onSubmit={handlePassWordSubmit} action="">
          ...
          <H3
            className={''}
            h3={'Lunghezza minima: 8 caratteri (consigliati 12 o più)'}
          />
          <div className="my-6 flex flex-col gap-3">
            <H3 className={''} h3={'Deve includere almeno:'} />
            <P className={''} p={'1 lettera maiuscola (A–Z)'} />
            <P className={''} p={'1 lettera minuscola (a–z)'} />
            <P className={''} p={'1 numero (0–9)'} />
            <P className={''} p={'1 carattere speciale (!, ?, $, %, &)'} />
          </div>
          <H3
            className={''}
            h3={
              'Non deve contenere nome utente, nome reale o altre informazioni facilmente intuibili'
            }
          />
          <Input
            TClassName={''}
