    ...
    <div className="flex h-auto flex-col bg-white md:h-screen">
      <div className="mx-auto w-full max-w-5xl flex-1 px-6 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <Paragraph className="text-sm text-gray-600">Steps 3/3</p>
        ...
        <form onSubmit={handlePassWordSubmit} action="">
          ...
          <Heading level={3}>Lunghezza minima: 8 caratteri (consigliati 12 o più)</Heading>
          ...
          <Heading level={3}>Non deve contenere nome utente, nome reale o altre informazioni facilmente intuibili</Heading>
          <Input
            TClassName={''}
            className={'w-full'}
            name={'confirmPass'}
